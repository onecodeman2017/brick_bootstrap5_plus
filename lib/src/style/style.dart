...
StyleAbbrSet getStyle(
  ...
  final borderRadiustopLeft = styles?.borderRadiustopLeft;
  final borderRadiustopRight = styles?.borderRadiustopRight;
  final borderRadiusbottomLeft = styles?.borderRadiusbottomLeft;
  final borderRadiusbottomRight = styles?.borderRadiusbottomRight;

  final borderRadiusTop = styles?.borderRadiusTop;
  final borderRadiusBottom = styles?.borderRadiusBottom;
  final borderRadiusLeft = styles?.borderRadiusLeft;
  final borderRadiusRight = styles?.borderRadiusRight;

  final borderTop = styles?.borderTop;
  final borderBottom = styles?.borderBottom;
  final borderLeft = styles?.borderLeft;
  final borderRight = styles?.borderRight;
  ...
  final borderColor0 = screenData.breakPoints._currentColor(
    screenData.currentBreakPoint,
    fromStyle: borderColor?.defaultColor,
    xs: borderColor?.xs,
    sm: borderColor?.sm,
    md: borderColor?.md,
    lg: borderColor?.lg,
  ...
  final borderRadius0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadius?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadius?.xs,
    sm: borderRadius?.sm,
    md: borderRadius?.md,
  ...
  /// LeftTop边框圆角
  final borderRadiustopLeft0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiustopLeft?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiustopLeft?.xs,
    sm: borderRadiustopLeft?.sm,
    md: borderRadiustopLeft?.md,
    lg: borderRadiustopLeft?.lg,
    xl: borderRadiustopLeft?.xl,
    xxl: borderRadiustopLeft?.xxl,
    unit: 'px',
  );

  /// topRight边框圆角
  final borderRadiustopRight0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiustopRight?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiustopRight?.xs,
    sm: borderRadiustopRight?.sm,
    md: borderRadiustopRight?.md,
    lg: borderRadiustopRight?.lg,
    xl: borderRadiustopRight?.xl,
    xxl: borderRadiustopRight?.xxl,
    unit: 'px',
  );

  /// bottomRight边框圆角
  final borderRadiusbottomLeft0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusbottomLeft?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusbottomLeft?.xs,
    sm: borderRadiusbottomLeft?.sm,
    md: borderRadiusbottomLeft?.md,
    lg: borderRadiusbottomLeft?.lg,
    xl: borderRadiusbottomLeft?.xl,
    xxl: borderRadiusbottomLeft?.xxl,
    unit: 'px',
  );

  /// bottomRight边框圆角
  final borderRadiusbottomRight0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusbottomRight?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusbottomRight?.xs,
    sm: borderRadiusbottomRight?.sm,
    md: borderRadiusbottomRight?.md,
    lg: borderRadiusbottomRight?.lg,
    xl: borderRadiusbottomRight?.xl,
    xxl: borderRadiusbottomRight?.xxl,
    unit: 'px',
  );

  /// Top边框圆角
  final borderRadiusTop0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusTop?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusTop?.xs,
    sm: borderRadiusTop?.sm,
    md: borderRadiusTop?.md,
    lg: borderRadiusTop?.lg,
    xl: borderRadiusTop?.xl,
    xxl: borderRadiusTop?.xxl,
    unit: 'px',
  );

  /// Bottom边框圆角
  final borderRadiusBottom0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusBottom?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusBottom?.xs,
    sm: borderRadiusBottom?.sm,
    md: borderRadiusBottom?.md,
    lg: borderRadiusBottom?.lg,
    xl: borderRadiusBottom?.xl,
    xxl: borderRadiusBottom?.xxl,
    unit: 'px',
  );

  /// Left边框圆角
  final borderRadiusLeft0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusLeft?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusLeft?.xs,
    sm: borderRadiusLeft?.sm,
    md: borderRadiusLeft?.md,
    lg: borderRadiusLeft?.lg,
    xl: borderRadiusLeft?.xl,
    xxl: borderRadiusLeft?.xxl,
    unit: 'px',
  );

  /// Left边框圆角
  final borderRadiusRight0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRadiusRight?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRadiusRight?.xs,
    sm: borderRadiusRight?.sm,
    md: borderRadiusRight?.md,
    lg: borderRadiusRight?.lg,
    xl: borderRadiusRight?.xl,
    xxl: borderRadiusRight?.xxl,
    unit: 'px',
  );

  final borderTop0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderTop?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderTop?.xs,
    sm: borderTop?.sm,
    md: borderTop?.md,
  ...
  final borderBottom0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderBottom?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderBottom?.xs,
    sm: borderBottom?.sm,
    md: borderBottom?.md,
    lg: borderBottom?.lg,
    xl: borderBottom?.xl,
    xxl: borderBottom?.xxl,
    unit: 'px',
  );

  final borderLeft0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderLeft?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderLeft?.xs,
    sm: borderLeft?.sm,
    md: borderLeft?.md,
  ...
  final borderRight0 = screenData.breakPoints._currentWidth1(
    constraints.maxWidth,
    screenData.currentBreakPoint,
    fromStyle: borderRight?.defaultWidth,
    // fromStyle: fontSize?.defaultFontSize,
    xs: borderRight?.xs,
    sm: borderRight?.sm,
    md: borderRight?.md,
  ...
  final shadowColor0 = screenData.breakPoints._currentColor(
    screenData.currentBreakPoint,
    fromStyle: shadowColor?.defaultColor,
    xs: shadowColor?.xs,
    sm: shadowColor?.sm,
    md: shadowColor?.md,
    lg: shadowColor?.lg,
  ...
  final shadowBlurRadius0 = screenData.breakPoints._currentShadowBlurRadius(
    screenData.currentBreakPoint,
    fromStyle: shadowBlurRadius?.defaultWidth,
  ...
  final _opacity = screenData.breakPoints._currentOpacity(
    screenData.currentBreakPoint,
    fromStyle: opacity?.defaultWidth,
    xs: opacity?.xs,
    sm: opacity?.sm,
    md: opacity?.md,
    lg: opacity?.lg,
  ...
  return StyleAbbrSet(
    ...
    borderRadiustopLeft: borderRadiustopLeft0,
    borderRadiustopRight: borderRadiustopRight0,
    borderRadiusbottomLeft: borderRadiusbottomLeft0,
    borderRadiusbottomRight: borderRadiusbottomRight0,
    borderRadiusTop: borderRadiusTop0,
    borderRadiusBottom: borderRadiusBottom0,
    borderRadiusLeft: borderRadiusLeft0,
    borderRadiusRight: borderRadiusRight0,
    borderTop: borderTop0,
    borderBottom: borderBottom0,
    borderLeft: borderLeft0,
    borderRight: borderRight0,
    fit: fit0,
    stackFit: stackFit0,
    blur: blur0,
    scale: scale0,
...
class StyleAbbrSet {
  ...
  /// Left边框圆角
  double? borderRadiusLeft;

  /// Right边框圆角
  double? borderRadiusRight;
