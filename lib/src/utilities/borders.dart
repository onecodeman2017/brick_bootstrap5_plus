...
BoxDecoration? getBoxDecorationByStyle(StyleAbbrSet s, [bool? isHover]) {
  Color? color = isHover == true ? s.hoverColor ?? s.bg : s.bg;
  Color borderColor = isHover == true
  ...
  BoxBorder? border = Border(
    top: BorderSide(
      width: s.borderTop ?? s.border ?? 0,
      color: borderColor,
    ),
    bottom: BorderSide(
      width: s.borderBottom ?? s.border ?? 0,
      color: borderColor,
    ),
    left: BorderSide(
      width: s.borderLeft ?? s.border ?? 0,
      color: borderColor,
    ),
    right: BorderSide(
      width: s.borderRight ?? s.border ?? 0,
      color: borderColor,
    ),
  );
  ...
  if (s.borderRadius != null) {
    borderRadius = BorderRadius.all(Radius.circular(s.borderRadius ?? 0));
  } else {
    if (s.borderRadiusTop != null) {
      borderRadius = BorderRadius.vertical(
        top: Radius.circular(s.borderRadiusTop ?? 0),
      );
    } else if (s.borderRadiusBottom != null) {
      borderRadius = BorderRadius.vertical(
          bottom: Radius.circular(s.borderRadiusBottom ?? 0));
    } else if (s.borderRadiusLeft != null) {
      borderRadius = BorderRadius.horizontal(
        left: Radius.circular(s.borderRadiusLeft ?? 0),
      );
    } else if (s.borderRadiusRight != null) {
      borderRadius = BorderRadius.horizontal(
          right: Radius.circular(s.borderRadiusRight ?? 0));
    } else {
      borderRadius = BorderRadius.only(
        topLeft: Radius.circular(s.borderRadiustopLeft ?? 0),
        topRight: Radius.circular(s.borderRadiustopRight ?? 0),
        bottomLeft: Radius.circular(s.borderRadiusbottomLeft ?? 0),
        bottomRight: Radius.circular(s.borderRadiusbottomRight ?? 0),
      );
    }
  }
